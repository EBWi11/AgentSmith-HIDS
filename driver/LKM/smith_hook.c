...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 38)
        pathstr = dentry_path_raw((struct dentry *) p_regs_get_arg2(regs),pname_buf,PATH_MAX);
#else
        pathstr = __dentry_path((struct dentry *) p_regs_get_arg2(regs), pname_buf, PATH_MAX);
#endif
    }
