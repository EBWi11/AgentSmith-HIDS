pub const EXE_WHITELIST: &'static [&'static str] = &["/usr/libexec/pk-command-not-found","/usr/bin/chronyc","/usr/lib64/sa/sa1","/usr/bin/date","/usr/lib64/sa","/usr/bin/test","/usr/sbin/chronyd","/usr/sbin/rsyslogd","/usr/bin/clear"];
