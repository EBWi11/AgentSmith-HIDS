...
fn get_data_no_callback(tx: Sender<Vec<u8>>) {
    ...
    loop {
        ...
        if msg.len() > 16 {
            ...
            let mut execve_msg = ["{".to_string(), "\"uid\":\"".to_string(), ",\"data_type\":\"".to_string(), ",\"run_path\":\"".to_string(), ",\"exe\":\"".to_string(), ",\"argv\":\"".to_string(), ",\"pid\":\"".to_string(), ",\"ppid\":\"".to_string(), ",\"pgid\":\"".to_string(), ",\"tgid\":\"".to_string(), ",\"comm\":\"".to_string(), ",\"nodename\":\"".to_string(), ",\"stdin\":\"".to_string(), ",\"stdout\":\"".to_string(), ",\"sessionid\":\"".to_string(), ",\"dip\":\"".to_string(), ",\"dport\":\"".to_string(), ",\"sip\":\"".to_string(), ",\"sport\":\"".to_string(), ",\"sa_family\":\"".to_string(), ",\"socket_exist\":\"".to_string(), ",\"pid_tree\":\"".to_string(), ",\"tty_name\":\"".to_string(), ",\"user\":\"".to_string(), ",\"time\":\"".to_string(), local_ip_str.to_string(), hostname_str.to_string(), ",\"exe_md5\":\"".to_string(), "}".to_string()];
                        ...
                        match i {
                            4 => {
                                if exe_white_list.contains(s) {
                                    ...
                                    execve_msg[27].push_str(&md5_str);
                                    execve_msg[27].push_str(tmp);
